...
We provide a HTML code for a graph (graph.rar) to aid visualization of the sensitivities (ppm) and what gases each sensor reacts To. When designing your own system you should take into account the following points: 
